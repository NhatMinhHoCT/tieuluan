...
if (isset($_POST['taomoi'])) {
  ...
  if ($image != null) {
    // var_dump($name, $code, $brand, $image, $price, $description, $kind, $machineType, $color, $origin, $diameter, $watchChain, $guarantee);
    $product->insertProduct($name, $code, $brand, $image, $price, $description, $kind, $machineType, $color, $origin, $diameter, $watchChain, $guarantee);
  }
}
    ...
    <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>">
      <div class="col-sm-12 col-xl-8">
        <div class=" rounded h-100 p-4">
          ...
          <div class="form-floating mb-3">
            <select class="form-select pb-2" id="brand" name="brand" aria-label="Floating label select example">
