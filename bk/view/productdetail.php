      ...
      <div class="col-lg-8 col-xl-9">
        <div class="row g-4">
          ...
          <div class="col-lg-6">
            ...
            <p class="mb-3">Mã sản phẩm: <?php echo strtoupper($data->code) ?></p>
            ...
            <?php
            if ($storage->emptyStorage($idProduct)){
echo '<span class="fs-6 badge bg-danger">Hết hàng</span>';
            }else{
echo '<button id="addToCartBtn" class="btn border border-primary rounded-pill px-4 py-2 mb-4 text-primary"><i class="fa fa-shopping-bag me-2"></i>Thêm vào giỏ hàng</button>
         ';
            }
            ?>
             </div>
