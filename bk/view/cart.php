    ...
    <div class="col-sm-12 col-lg-6 col-xl-3">
      <div class="bg-light rounded">
        ...
        if (!isset($_SESSION['user_id'])) {
          echo
          '<a class="btn btn-primary rounded py-3 text-light text-uppercase mb-4 ms-4" type="button" data-bs-toggle="modal" data-bs-target="#NotiModal">
  Thanh toán
</a>';
        } else if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
          echo '<a href="checkout.php" class="btn btn-primary rounded px-4 py-3 text-light text-uppercase mb-4 ms-4" type="button">
        Thanh toán</a>';
        } else {
          echo
          '<a class="btn btn-primary cart_empty rounded px-4 py-3 text-light text-uppercase mb-4 ms-4" type="button">
        Thanh toán</a>';
        }
        ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header py-3 text-center">
        <h4 class="modal-title text-center fs-4 mx-auto">Thông báo</h4>
...
<script>
  ...
  $(document).ready(function() {
    $('.cart_empty').click(function() {
      setTimeout(function() {
        showToast("Thông báo", "Chưa có sản phẩm trong giỏ hàng", "warning")
      }, 500)
    });
  });
</script>
