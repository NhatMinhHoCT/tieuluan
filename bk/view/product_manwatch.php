             ...
             <div class="row g-4">
               <?php
                ...
                if (isset($_GET['supplier']) || isset($_GET['search']) || isset($_GET['chain']) || isset($_GET['price'])) {
                  ...
                  $row = $product->getProduct($search, $supplier, $chain, $price, $kind, $start, $limit, 2);
                } else {
                  $totalItems = $product->countProduct(null, null, null, null, $kind);
                  $row = $product->getProduct(null, null, null, null, $kind, $start, $limit, 2);
                }
               ...
               <?php
                  ...
                  echo '<img src="../include/img/search-bar.gif" class="img-fluid w-100" alt="image-search" >';
                  echo '</div>';
                }
                ?>
               <div class="col-12">
